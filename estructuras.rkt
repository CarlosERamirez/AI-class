...
(define color1 (make-color 255 0 0))
(circle 50 "solid" "red")
...
(add-line (empty-scene 160 90)
          ...
          (posn-x posn2) (posn-y posn2) color1)
...
(check-expect (prom-edades ldr) (/ 89 4))

;draw-lines
;Consume una lista de posns una imagen y un color
;Produce una imagen con límeas uniendo los posns sobre la imagen
